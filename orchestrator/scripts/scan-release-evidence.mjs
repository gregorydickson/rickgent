...
const allowedKeys = new Set([
  ...
  "attempt_process_ids", "controller_process_id", "entrypoint", "executable_sha256",
  "identity_sha256", "independently_requeried", "infrastructure_errors", "installed_executable_realpath", "installed_lifecycle",
