---
name: rickgent-prd
description: "Draft and validate a PRD using rickgent's prd command. Use when the user needs to define a new feature, fix, or refactor before implementation."
metadata:
  short-description: "Rickgent PRD drafter"
---

# Rickgent PRD Drafter

Help the user create and validate a PRD using rickgent's prd command.
